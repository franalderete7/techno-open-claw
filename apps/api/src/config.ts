...
const configSchema = z.object({
  ...
  ORSHOT_API_BASE_URL: z.string().default("https://api.orshot.com"),
  ORSHOT_API_KEY: z.string().default(""),
  ORSHOT_WEBHOOK_URL: z.string().default(""),
  ORSHOT_CLI_PATH: z.string().default("orshot"),
  RUNWAY_API_BASE_URL: z.string().default("https://api.dev.runwayml.com"),
